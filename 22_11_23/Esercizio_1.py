...
mask=np.logical_and(massa_dec>2.95, massa_dec<3.25)
...
n,p,bins=ins.hist(massa_int, bins=200,range=(2.95,3.25),color="gold")
...
if(int(b)==1):
    ...
    ax[0].hist(massa_int, bins=200,range=(2.95,3.25),color="goldenrod",alpha=0.7)
...
if(int(b)==1):
    ...
    ax[0].hist(massa_int, bins=200,range=(2.95,3.25),color="red",alpha=0.4)
    ax[0].set_xlabel("mc^2(mGeV/s^2)")
    ax[0].set_ylabel("Events/3GeV")
    plt.show()
